 ...
 * @author zhanglinfeng
 */
public class EmailDesensitization implements DefaultDesensitization {
    /**
     * 脱敏实现
     *
     * @param target 脱敏对象
    ...
    public String desensitize(String target,int prefixLen, int suffixLen) {
        ...
        String desensitizedPrefix = prefix.length() <= 2 ? prefix :
                DesensitizationUtils.desensitizeCustom(prefix, 2, 0);
