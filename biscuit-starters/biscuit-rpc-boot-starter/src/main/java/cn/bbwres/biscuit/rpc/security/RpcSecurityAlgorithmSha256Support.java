 ...
 */
@Slf4j
public class RpcSecurityAlgorithmSha256Support extends AbstractRpcSecurityAlgorithmHashSupport {


    public RpcSecurityAlgorithmSha256Support(RpcSecurityProperties rpcSecurityProperties, Environment environment) {
    ...
    protected String hash(String waitSignStr) {
        return DigestUtils.sha256Hex(waitSignStr.getBytes(StandardCharsets.UTF_8));
    }
