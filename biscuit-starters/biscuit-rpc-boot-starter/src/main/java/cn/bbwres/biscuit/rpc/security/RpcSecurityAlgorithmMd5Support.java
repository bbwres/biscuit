 ...
 */
@Slf4j
public class RpcSecurityAlgorithmMd5Support extends AbstractRpcSecurityAlgorithmHashSupport {



    public RpcSecurityAlgorithmMd5Support(RpcSecurityProperties rpcSecurityProperties, Environment environment) {
    ...
    protected String hash(String waitSignStr) {
        return DigestUtils.md5Hex(waitSignStr.getBytes(StandardCharsets.UTF_8));
    }
